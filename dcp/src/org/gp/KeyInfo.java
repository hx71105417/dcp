...
@XmlRootElement(name = "KeyInfo", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class KeyInfo {

    @XmlElement(name = "KeyPart", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected KeyPart keyPart;
    @XmlElement(name = "TransportKey", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")

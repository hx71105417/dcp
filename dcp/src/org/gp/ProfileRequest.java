 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-messaging/2.1.0}ProfileIdentification" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="type" use="required" type="{http://namespaces.globalplatform.org/systems-messaging/2.1.0}profileType" />
 *       &lt;attribute name="ProfileUniqueID" type="{http://namespaces.globalplatform.org/systems-messaging/2.1.0}uniqueID" />
 *       &lt;attribute name="ProfileVersion" type="{http://namespaces.globalplatform.org/systems-profiles/1.1.2}version" />

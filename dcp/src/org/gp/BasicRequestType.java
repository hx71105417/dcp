...
@XmlSeeAlso({
    UpgradeServiceRequestType.class,
    UnbindDeviceApplicationToSEApplicationRequestType.class,
    BindDeviceApplicationToSEApplicationRequestType.class,
    HandleActionDoneOnServiceNotificationRequestType.class,
    CheckGlobalEligibilityRequestType.class,
    ...
    TerminateServiceRequestType.class,
    GetCAInformationRequestType.class,
    HandleSEDeviceStatusChangeNotificationRequestType.class,
    SuspendOrResumeServiceRequestType.class,
    ...
    HandleServiceEnvironmentChangeNotificationRequestType.class,
    HandleActionDoneOnDeviceApplicationNotificationRequestType.class,
    ...
    ExchangeServiceDataRequestType.class,
    DeployServiceRequestType.class,
    ...
    GetMobileSubscriptionSEIdentifiersRequestType.class,
    HandleSERenewalNotificationRequestType.class,
    LookupServiceInstanceReferenceRequestType.class,
    DeclareServiceInstanceReferenceRequestType.class,
    GetServiceInstanceReferenceDescriptorRequestType.class,
    GetServiceStateRequestType.class,
    BeginConversationRequestType.class,
    SendScriptRequestType.class,
    GetSDFreeMemoryRequestType.class,

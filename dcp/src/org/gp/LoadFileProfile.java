...
@XmlRootElement(name = "LoadFileProfile", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class LoadFileProfile {
    ...
    @XmlElement(name = "LoadFileInfo", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected LoadFileInfo loadFileInfo;
    @XmlElement(name = "Modules", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected Modules modules;
    @XmlElement(name = "ApplicationCode", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")

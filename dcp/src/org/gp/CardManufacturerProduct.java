...
@XmlRootElement(name = "CardManufacturerProduct", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class CardManufacturerProduct {
    ...
    @XmlElement(name = "CardManufacturer", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected CardManufacturer cardManufacturer;
    @XmlElement(name = "Chip", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected Chip chip;
    @XmlElement(name = "Platform", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)

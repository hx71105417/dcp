...
@XmlRootElement(name = "CryptoEngine", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class CryptoEngine {

    @XmlElement(name = "Description", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected String description;
    @XmlElement(name = "KeyTypes", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected KeyTypes keyTypes;
    @XmlElement(name = "Algorithm", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)

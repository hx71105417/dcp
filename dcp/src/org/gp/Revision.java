...
@XmlRootElement(name = "Revision", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class Revision {

    @XmlElement(name = "Description", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected String description;
    @XmlElement(name = "Signature", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")

...
@XmlRootElement(name = "SecureChannel", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class SecureChannel {

    @XmlElement(name = "OpenSecureChannel", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected OpenSecureChannel openSecureChannel;
    @XmlElement(name = "CloseSecureChannel", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected CloseSecureChannel closeSecureChannel;
    @XmlElement(name = "Wrap", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected Wrap wrap;

...
@XmlRootElement(name = "ScriptFragment", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class ScriptFragment {
    ...
    @XmlElement(name = "ConflictRules", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected ConflictRules conflictRules;
    @XmlElement(name = "Declaration", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")

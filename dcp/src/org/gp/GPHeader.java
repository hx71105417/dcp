 ...
 *             &lt;/complexType>
 *           &lt;/element>
 *           &lt;element ref="{http://namespaces.globalplatform.org/systems-messaging/2.1.0}MessageContext" minOccurs="0"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *       &lt;attribute name="TransactionID" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="Source" use="required" type="{http://namespaces.globalplatform.org/systems-messaging/2.1.0}OID" />
 *       &lt;attribute name="Destination" use="required" type="{http://namespaces.globalplatform.org/systems-messaging/2.1.0}OID" />
 *       &lt;attribute name="Type" use="required" type="{http://namespaces.globalplatform.org/systems-messaging/2.1.0}messageType" />
 *       &lt;attribute name="MessageVersion" use="required" type="{http://namespaces.globalplatform.org/systems-profiles/1.1.2}version" />

 ...
 *         &lt;element name="FunctionExecutionStatus" type="{http://namespaces.globalplatform.org/systems-messaging/2.1.0}ExecutionStatusType"/>
...
@XmlSeeAlso({
    CheckGlobalEligibilityResponseType.class,
    ...
    ExchangeServiceDataResponseType.class,
    DeleteSCWSServicePortalResponseType.class,
    LookupServiceInstanceReferenceResponseType.class,
    EndConversationResponseType.class,
    GetServiceInstanceReferenceDescriptorResponseType.class,
    GetSECapabilityProfileIdResponseType.class,
    DeployServiceResponseType.class,
    GetCAInformationResponseType.class,
    SendScriptResponseType.class,
    DeclareServiceInstanceReferenceResponseType.class,
    CheckMobileSubscriptionEligibilityResponseType.class,
    GetMobileSubscriptionSEIdentifiersResponseType.class,
    UpgradeServiceResponseType.class,
    SuspendOrResumeServiceResponseType.class,
    SECommandsGenerationAndRemoteExecutionResponseType.class,
    GetApplicationOrELFStatusResponseType.class,
    GetSDFreeMemoryResponseType.class,

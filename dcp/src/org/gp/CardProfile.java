...
@XmlRootElement(name = "CardProfile", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class CardProfile {
    ...
    @XmlElement(name = "CardManufacturerProduct", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    ...
    @XmlElement(name = "LoadFileInstances", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected LoadFileInstances loadFileInstances;
    @XmlElement(name = "ApplicationInstances", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected ApplicationInstances applicationInstances;
    @XmlElement(name = "CardInfo", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)

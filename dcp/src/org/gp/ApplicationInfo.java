...
@XmlRootElement(name = "ApplicationInfo", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class ApplicationInfo {

    @XmlElement(name = "Privileges", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected Privileges privileges;
    @XmlElement(name = "LifeCycles", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)

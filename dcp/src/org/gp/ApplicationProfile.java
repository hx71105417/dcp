 ...
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.2}ApplicationInfo"/>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.2}Key" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.2}DataElement" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.2}Function" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.2}SecureChannel" minOccurs="0"/>
 *         &lt;element ref="{http://namespaces.globalplatform.org/systems-profiles/1.1.2}ScriptFragment" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "ApplicationProfile", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class ApplicationProfile {

    @XmlElement(name = "Description", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected String description;
    @XmlElement(name = "Revisions", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected Revisions revisions;
    @XmlElement(name = "ConflictRules", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected ConflictRules conflictRules;
    @XmlElement(name = "ApplicationInfo", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected ApplicationInfo applicationInfo;
    @XmlElement(name = "Key", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected List<Key> key;
    @XmlElement(name = "DataElement", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected List<DataElement> dataElement;
    @XmlElement(name = "Function", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected List<Function> function;
    @XmlElement(name = "SecureChannel", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected SecureChannel secureChannel;
    @XmlElement(name = "ScriptFragment", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")

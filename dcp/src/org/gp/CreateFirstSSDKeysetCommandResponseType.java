...
@XmlSeeAlso({
    ...
    CCCMScenario3CreateFirstSSDKeysetCommandResponseType.class,
    BasicRandomCreateFirstSSDKeysetCommandResponseType.class,
    BasicDiversifiedCreateFirstSSDKeysetCommandResponseType.class
})
public abstract class CreateFirstSSDKeysetCommandResponseType

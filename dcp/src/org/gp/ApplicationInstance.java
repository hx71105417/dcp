...
@XmlRootElement(name = "ApplicationInstance", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class ApplicationInstance {

    @XmlElement(name = "Privileges", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")

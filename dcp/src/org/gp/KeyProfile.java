...
@XmlRootElement(name = "KeyProfile", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class KeyProfile {
    ...
    @XmlElement(name = "KeyInfo", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected KeyInfo keyInfo;
    @XmlElement(name = "Attribute", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected Attribute attribute;
    @XmlElement(name = "Usage", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected Usage usage;
    @XmlElement(name = "Value", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")

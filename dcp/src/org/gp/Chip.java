...
@XmlRootElement(name = "Chip", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
public class Chip {

    @XmlElement(name = "Description", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected String description;
    @XmlElement(name = "Resources", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected Resources resources;
    @XmlElement(name = "Powers", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected Powers powers;
    @XmlElement(name = "Clock", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")
    protected Clock clock;
    @XmlElement(name = "Communication", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2", required = true)
    protected Communication communication;
    @XmlElement(name = "CryptoEngine", namespace = "http://namespaces.globalplatform.org/systems-profiles/1.1.2")

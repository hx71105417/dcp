...
/**
 * This function is used to request information about components present on a Secure Element.The command is used to audit one or many components among Applications, Security Domains, and Executable Load Files.
 * 
 ...
 *         &lt;element name="ApplicationOrExecutableLoadFileAID" type="{http://namespaces.globalplatform.org/systems-messaging/2.1.0}AIDType" maxOccurs="unbounded"/>
